...
const Neighborhoods1 = () => {
  ...
  <div className="col-sm-6 col-lg-3">
    ...
    <ul className="list-unstyled">
      <li><Link to="/DetaisPages">ভালুকা</Link></li>
      <li><Link to="/bashundhara">পশ্চিম ভালুকা</Link></li>
      <li><Link to="/uttara">চাঁপড়া</Link></li>
      <li><Link to="/mirpur">খলিলপুর</Link></li>
      <li><Link to="/aftab-nagar">আগলা</Link></li>
      <li><Link to="/badda">কড়চি</Link></li>
      <li><Link to="/badda">কাটুয়ার</Link></li>
    </ul>
  </div>
  ...
  <div className="col-sm-6 col-lg-3">
    <h5>মল্লিকবাড়ী :</h5>
    <ul className="list-unstyled">
      <li><Link to="/bayazid">মল্লিকবাড়ী</Link></li>
      <li><Link to="/double-mooring">নয়নপুর</Link></li>
      <li><Link to="/khulshi">আছিরপুর</Link></li>
      <li><Link to="/chawk-bazaar">ভানুগাছ</Link></li>
      <li><Link to="/chandgaon">তীরথপুর</Link></li>
      <li><Link to="/chandgaon">ছায়াঘর</Link></li>
      <li><Link to="/chandgaon">পলাশপুর</Link></li>
    </ul>
  </div>
  ...
  <div className="col-sm-6 col-lg-3">
    <h5>ডাকাতিয়া :</h5>
    <ul className="list-unstyled">
      <li><Link to="/bayazid">ডাকাতিয়া</Link></li>
      <li><Link to="/double-mooring">দিঘলকান্দি</Link></li>
      <li><Link to="/khulshi">কাচিনা</Link></li>
      <li><Link to="/chawk-bazaar">শ্রীপুর</Link></li>
      <li><Link to="/chandgaon">ভেড়াবাড়ী</Link></li>
      <li><Link to="/chandgaon">বালুরচর</Link></li>
      <li><Link to="/chandgaon">বরাহধী</Link></li>
    </ul>
  </div>
  ...
  <div className="col-sm-6 col-lg-3">
    <h5>উথুরা :</h5>
    <ul className="list-unstyled">
      <li><Link to="/bayazid">উথুরা</Link></li>
      <li><Link to="/double-mooring">আছিরপুর</Link></li>
      <li><Link to="/khulshi">সান্দালপুর</Link></li>
      <li><Link to="/chawk-bazaar">আঠারো খামার</Link></li>
      <li><Link to="/chandgaon">মন্ডলীপুর</Link></li>
      <li><Link to="/chandgaon">বেতবাড়ী</Link></li>
      <li><Link to="/chandgaon">পশ্চিম উথুরা</Link></li>
    </ul>
  </div>
